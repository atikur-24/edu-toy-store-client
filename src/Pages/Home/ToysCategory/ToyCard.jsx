  ...
  return (
    <div className="card card-compact w-96 bg-base-100 shadow-xl">
      ...
      <div className="card-body">
        ...
        <p className='text-xl font-semibold text-gray-500 mb-5'>$ {price}</p>
        <div className="flex justify-between items-center">
          ...
          <Link onClick={notify} to={`/details/${_id}`} className="btn btn-outline btn-primary btn-sm">View Details <span className='ml-2'><FaArrowRight /></span> </Link>
          <ToastContainer />
        </div>
      </div>
    </div>
